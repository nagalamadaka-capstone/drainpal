...
function GeneralCare({ handleSignInOpen, handleCreateAccOpen, isLoggedIn }) {
  return (
    <div className="palliativeCare">
      ...
      <div className="notNavbar">
        <div className="wrapper">
          <h1>
            PERCUTANEOUS NEPHROSTOMY TUBE: General Drain Information and Care
            Instructions
          </h1>
          <p>
            A nephrostomy tube is a flexible rubber tube that goes through the
            skin into the kidney. The tube is used to drain urine from the
            kidney to a bag outside the body.
          </p>
